        ...
        mAuth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Intent intent = new Intent(Activity_olvidaste_contrasena.this, Activity_login.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(Activity_olvidaste_contrasena.this, "No se pudo enviar el correo.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
